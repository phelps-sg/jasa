...
public class McAfeeClearingHouseAuctioneerTest extends TestCase {
	...
	public void testClearingNoUnmatchedShouts() {
		...
		traders[0].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[0],
		    1, 200, true) }));
		traders[1].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[1],
		    1, 150, true) }));

		traders[2].setIsSeller(true);
		traders[3].setIsSeller(true);
		traders[2].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[2],
		    1, 100, false) }));
		traders[3].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[3],
		    1, 140, false) }));
	...
	public void testInefficientClearing() {
		...
		traders[3].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[3],
		    1, 50, false) }));
		traders[4].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[4],
		    1, 100, false) }));
		traders[5].setStrategy(new MockStrategy(new Shout[] { new Shout(traders[5],
		    1, 1150, false) }));
