...
public class Output implements Serializable
    ...
    /** Sets the global (static) verbosity of Output objects to <i>v</i>. */
    public synchronized int setGlobalVerbosity(int v)
        {
        int oldVerbosity = globalVerbosity;
        globalVerbosity=v;
        return oldVerbosity;
        }

    /** Returns the global (static) verbosity of Output objects */
    public synchronized int getGlobalVerbosity()
        {
    ...
    protected synchronized void println(String s,
        ...
        if (globalVerbosity >= _verbosity) return; // don't write it
        // now write it
