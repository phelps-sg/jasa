...
public class InternalCrossoverPipeline extends GPBreedingPipeline
    ...
    public Object protoClone() throws CloneNotSupportedException
        {
        InternalCrossoverPipeline c = (InternalCrossoverPipeline)(super.protoClone());
        
        // deep-cloned stuff
        c.nodeselect0 = (GPNodeSelector)(nodeselect0.protoClone());
    ...
    public void setup(final EvolutionState state, final Parameter base)
        ...
        if (state.parameters.exists(p,d) &&
            ...
            nodeselect1 = (GPNodeSelector)(nodeselect0.protoCloneSimple());
        else
            {
        ...
        for(int q=start;q<n+start; q++)
            ...
            if (tree1==TREE_UNFIXED || tree2==TREE_UNFIXED) 
                ...
                do
                    ...
                    } while (i.trees[t1].constraints() != i.trees[t2].constraints());
                }
            else
                {
                t1 = tree1;
                ...
                if (i.trees[t1].constraints() 
                    != i.trees[t2].constraints()) // uh oh
            ...
            for(int x=0;x<numTries;x++)
                ...
                res = (p1!=p2 &&
                       ...
                       // check for validity
                       verifyPoints(p1,p2) &&   // 1 goes into 2
                       verifyPoints(p2,p1));    // 2 goes into 1
