...
public class MutateOneNodePipeline extends GPBreedingPipeline
    ...
    public Object protoClone() throws CloneNotSupportedException
        {
        MutateOneNodePipeline c = (MutateOneNodePipeline)(super.protoClone());
    ...
    public int produce(final int min, 
        ...
        for(int q=start; q < n+start; q++)
            ...
            p2 = (GPNode)(pickCompatibleNode(p1,i.trees[t].constraints().functionset,state,type,thread)).protoClone();
