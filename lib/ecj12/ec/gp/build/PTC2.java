...
public class PTC2 extends GPNodeBuilder 
    ...
    public GPNode newRootedTree(final EvolutionState state,
                                ...
                                int requestedSize) throws CloneNotSupportedException
        {
        int t = type.type;
        ...
        if (requestedSize==1)  // return a terminal
            ...
            root = (GPNode)
                nn[RandomChoice.pickFromDistribution(
                       ...
                       state.random[thread].nextFloat(),CHECK_BOUNDARY)].node.protoClone();
            ...
            int s = 1;
            GPType[] childtypes = root.constraints().childtypes;
            ...
            while(!(s_size + s >= requestedSize || s_size==0))
                ...
                int y = dequeue_node.constraints().childtypes[dequeue_argpos].type;
                ...
                if (dequeue_depth==maxDepth)  // pick a terminal
                    ...
                    childtypes = n.constraints().childtypes;
                    for(int x=0;x<childtypes.length;x++)
