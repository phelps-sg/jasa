...
public class GPNodeConstraints implements Clique
    ...
    static
        {
        all = new Hashtable();
        constraints = new GPNodeConstraints[SIZE_OF_BYTE];
        numConstraints = 0;
        }
    ...
    public final void setup(final EvolutionState state, final Parameter base)
        ...
        // Register me
        GPNodeConstraints old_constraints = (GPNodeConstraints)(all.put(name,this));
    ...
    public static GPNodeConstraints constraintsFor(final String constraintsName,
        ...
        {
        GPNodeConstraints myConstraints = (GPNodeConstraints)(all.get(constraintsName));
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
        ...
        constraints = (GPNodeConstraints[]) in.readObject();
