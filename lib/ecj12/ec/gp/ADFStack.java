...
public class ADFStack implements Prototype 
    ...
    public Object protoClone() throws CloneNotSupportedException
        ...
        // deep-cloned stuff
        myobj.context_proto = (ADFContext)(context_proto.protoClone());
        ...
        for(int x=0;x<onStack;x++)
            myobj.stack[x] = (ADFContext)(stack[x].protoClone());
        for(int x=0;x<onSubstack;x++)
            myobj.substack[x] = (ADFContext)(substack[x].protoClone());
        for(int x=0;x<inReserve;x++)
            myobj.reserve[x] = (ADFContext)(reserve[x].protoClone());
        return myobj;
        }
    ...
    */
    public final ADFContext get()
        ...
        else obj = (ADFContext)(context_proto.protoCloneSimple());  // hopefully that doesn't have to happen too many times
        return obj;
        }
