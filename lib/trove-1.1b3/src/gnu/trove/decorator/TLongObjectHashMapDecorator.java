 ...
 * @since trove 0.1.8
 */
public class TLongObjectHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TLongObjectHashMap _map;
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Long && val instanceof Object) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TLongObjectIterator it = _map.iterator();
