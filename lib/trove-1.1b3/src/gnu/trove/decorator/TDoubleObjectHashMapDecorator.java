 ...
 * @since trove 0.1.8
 */
public class TDoubleObjectHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TDoubleObjectHashMap _map;
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Double && val instanceof Object) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TDoubleObjectIterator it = _map.iterator();
