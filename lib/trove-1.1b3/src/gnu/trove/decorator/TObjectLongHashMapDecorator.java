 ...
 * @since trove 0.1.8
 */
public class TObjectLongHashMapDecorator extends AbstractMap implements Map, Cloneable {
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Object && val instanceof Long) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TObjectLongIterator it = _map.iterator();
