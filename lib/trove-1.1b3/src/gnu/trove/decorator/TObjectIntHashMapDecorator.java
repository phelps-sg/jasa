 ...
 * @since trove 0.1.8
 */
public class TObjectIntHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TObjectIntHashMap _map;
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Object && val instanceof Integer) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TObjectIntIterator it = _map.iterator();
