 ...
 * @since trove 0.1.8
 */
public class TObjectDoubleHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TObjectDoubleHashMap _map;
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Object && val instanceof Double) {
