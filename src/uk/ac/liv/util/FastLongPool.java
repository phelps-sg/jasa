...
public class FastLongPool {
  ...
  public static FastLong fetch() {
    try {
      initialisePool();
      return (FastLong) pooler.fetch();
  ...
  public static FastLong fetch( long value ) {
    FastLong n = fetch();
    n.setValue(value);
    return n;
  }

  public static void release( FastLong object ) {
    pooler.release(object);
  }

  public static void setPoolSize( int poolSize ) {
    FastLongPool.poolSize = poolSize;
  }
