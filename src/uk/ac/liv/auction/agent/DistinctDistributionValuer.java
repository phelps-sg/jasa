...
public class DistinctDistributionValuer extends AbstractRandomValuer {
	...
	public void setup(ParameterDatabase parameters, Parameter base) {
		...
		minValueMin = parameters.getDouble(base.push(P_MINVALUEMIN), defBase
		    .push(P_MINVALUEMIN), 0.0);

		minValueMax = parameters.getDouble(base.push(P_MINVALUEMAX), defBase
		    .push(P_MINVALUEMAX), minValueMin);

		rangeMin = parameters.getDouble(base.push(P_RANGEMIN), defBase
		    .push(P_RANGEMIN), 0.0);

		rangeMax = parameters.getDouble(base.push(P_RANGEMAX), defBase
		    .push(P_RANGEMAX), rangeMax);
