 ...
 * @version $Revision$
 */
public class Ratio extends ParameterBasedCase {
	...
	public void apply(ParameterDatabase pdb, Parameter base) {
		...
		pdb.set(base.push(P_AGENTTYPE+".0."+P_NUMAGENTS), String.valueOf(sellerNum));
		pdb.set(base.push(P_AGENTTYPE+".1."+P_NUMAGENTS), String.valueOf(buyerNum));
	}
