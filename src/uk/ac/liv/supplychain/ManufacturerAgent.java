...
public class ManufacturerAgent extends SupplyChainAgent {
	...
	public void requestShout( Auction auction ) {
		if (false)
			System.out.println(auction.getAge()+" Av ManufacturerAgent.requestShout "+toString());
...
*/
		...
		if (false)
			System.out.println(auction.getAge()+" Ap ManufacturerAgent.requestShout "+toString());
	}//requestShout
}//class
