...
public class GPGenericIndividual extends GPSchemeIndividual implements
    Resetable {
  ...
  public void setup(EvolutionState state, Parameter base) {
    ...
    object = (GPObject) state.parameters.getInstanceForParameter(base
        .push(P_OBJECT), null, GPObject.class);
  ...
  public Object protoClone() throws CloneNotSupportedException {
    GPGenericIndividual clonedIndividual = (GPGenericIndividual) super
        .protoClone();
