...
define(`RESULTS', `CONF_OUTHOME/gpheuristic')
...
stat.file = RESULTS/gpheuristic.out
...
NEW_FUNCTION_SET(tradingStrategy, 21)
...
NEW_FUNCTION(uk.ac.liv.auction.ec.gp.func.LastProfit, numberterminal)
